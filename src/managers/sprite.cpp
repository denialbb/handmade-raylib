...
void initializePlayer(Texture2D texture) {
    ...
    _sprite_width = texture.width / _spritesheet_cols;
    _sprite_height = texture.height / _spritesheet_rows;
...
void drawPlayer(Vector2 position, Texture2D texture) {
    ...
    DrawTexturePro(texture, _player_sprite.sprite_rect, destRec, origin,
